(function() {
	...
	var pubnub = PUBNUB.init({
		publish_key     : 'pub-c-150fdb3a-1221-4a4d-844a-2d200e3ec2fc',
		subscribe_key   : 'sub-c-cb3013e6-32e5-11eb-9713-12bae088af96',
	...
	pubnub.subscribe({
		...
		presence: function(m){
			if(m.occupancy > 1){
				document.getElementById('unit').textContent = 'Students Online';
			}
