            ...
            <div class="row">
              <div class="col-12 ">
                <div class="card bg-dark shadow p-3 mb-3 bg-white rounded">
                  <img src="img/undraw_posting_photo.svg" height="175" class="card-img" alt="...">
                  <div class="card-img-overlay">
                    <h1 class="card-title"><b>Card title</b></h1>
                    <h3>TE IT BCE</h3>
                    <p class="card-text">Buisness Communication & Ethics</p>
                  </div>
                </div>
              </div>
              <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12 mb-2">
                                <div id = "clicked-post" class="card shadow-sm">
                                    <div class="card-body">
                                        <img src="img/image1.jpg" width="35" height="35" alt="..." class="rounded-circle mr-2 text-none">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="card shadow-sm mt-3">
                                        <div class="card-body">
                                            <img src="img/image1.jpg" width="35" height="35" alt="..." class="rounded-circle mr-2 mb-2 float-left">
                                        ...
                                        <div class="input-group mb-3 mt-3">
                                          <img src="img/image1.jpg" width="35" height="35" alt="..." class="rounded-circle ml-2 mr-2">
