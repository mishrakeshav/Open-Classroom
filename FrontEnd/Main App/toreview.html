      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-9">
              <div class="container-fluid">
                <h5 class="d-inline">No due date</h5>
                <h5 class="float-right">2</h5>
                <a href="classroom.html">
                  <div class="card mt-3 border-light p-1 mb-3 bg-light rounded" style="width:60px; height:20px;">
                    <div class="card-body">
...
<a href="To-do.html">
  <div class="card border-light p-1 mb-3 bg-light rounded">
    <div class="card-body">
      <img src="img/image1.jpg" width="35" height="35" alt="..." class="rounded-circle mr-2 mb-2 float-left">
      <div class="dropdown no-arrow float-right">
        <a class="btn btn-circle dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
